...
4. symbols covers the non-trivial notation needed for understanding, but do not list ordinary plus signs or invent variables to meet a count. Check object type, dimensions, indices, scope, and units. Details with no material support must not be guessed from convention into facts of this text.
